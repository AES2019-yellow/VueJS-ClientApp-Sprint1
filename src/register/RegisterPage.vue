    ...
    <div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                ...
                <input type="password" v-model="user.password_confirm" v-validate="{ required: true, min: 6 }" name="password_confirm" class="form-control" :class="{ 'is-invalid': submitted && errors.has('password') }" />
                <div v-if="submitted && errors.has('password')" class="invalid-feedback">{{ errors.first('password_confirm') }}</div>
            </div>
            <div class="form-group">
